...
class RoverCameraNode(Node):
    def __init__(self):
        ...
        self.get_logger().info(f'Starting RoverCameraNode with device: {device_path}, {width}x{height} @ {fps}fps')
        ...
        self.get_logger().info(f'Camera opened successfully on {device_path}')
